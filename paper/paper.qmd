...
This research focuses on ward-level data, filtering out "City Wide" funding, which represents investments distributed across the entire city rather than specific wards.


@tbl-demographics-stats summarizes the results of the research. 
...
@fig-percapitafunding shows a bar chart of the per capita funding allocated for each ward. 
...
Exploring the data reveals substantial disparities in per capita capital funding across Toronto's 25 wards. The per capita funding ranges dramatically, from as low as \$173.22 in Ward 15 to as high as \$7,674.47 in Ward 13. 

## Per Capita Funding and Household Median Income

 Across the household incomes, the average value is \$84,000. This means that 50% of wards have median household incomes of \$84,000 or less. Therefore, we will define a higher income ward as which has a median household income greater than \$84,000. Therefore, When comparing per capita funding to household median income, the pattern of wards with higher median household incomes tend to receive more capital funding per capita. For instance, of the top 5 wards with the highest per capita funding, 4 were higher income. Conversely, of the wards with the 5th lowest per capita funding, 4 were lower income. 

**Figure 1** illustrates this relationship. Ward 13 was removed from the analysis as it causes the data to be skewed and isn't an accurate representation of the relationship. As we can see, the trend line is going upwards which indicates a positive relationship between per capita funding and median household income. That is, as median house income increases, per capita funding typically also increases. 
...
Educational attainment appears to have a strong positive relationship with funding allocations. Wards where a higher percentage of residents hold a bachelor's degree or higher tend to receive more per capita funding. A higher percentage of residents holding a bachelor's degree or higher is defined as a 33%. 
...
Of the top 10 per capita funded wards, 4 have a higher percentage of visible minorities. While for the 10 lowest per capita funded, 6 have a higher percentage of visible minorities. 
More specifically:
