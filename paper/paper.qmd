...
merged_table_2 <- merged_table_select |>
  mutate(
    ...
    per_capita_funding = dollar(per_capita_funding),
      `Median total income of households in 2020 ($)` = paste0(
      dollar(as.numeric(`Median total income of households in 2020 ($)`)),
      ifelse(as.numeric(`Median total income of households in 2020 ($)`) <= 84000, "**", "")
    ),
...
Wards with a **\*\*** indicate a **Household Median Income** of \$84,000 or less.
...
FIGURE 1 HERE (MAYBE BOTH WITH WARD 13 AND WITHOUT WARD 13)
