...
# Clean budget data 
budget_data2 <- read_csv("data/raw_data/2024-2033-capital-budget-and-plan-details.csv")

# Remove rows where 'Ward Number' is "CW"
budget_data <- budget_data2 |>
...
write_csv(budget_data_clean, "data/analysis_data/clean_budget_data2.csv")
